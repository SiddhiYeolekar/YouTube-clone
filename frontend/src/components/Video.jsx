        ...
        <div className='video'> 
            ...
            <div>
                ...
                <div>
                    ...
                    <Link to={`/channels/${channel?._id || "unknown"}`}>
                        <img src={channel?.channelPic || ""} alt={channel?.channelName || "Unknown"} className='channel-icon' />
                    </Link>

                    <div className='channel-name'>{channel?.channelName || "Unknown Channel"}</div>
